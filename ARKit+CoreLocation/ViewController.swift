...
//        sceneLocationView.locationEstimateMethod = .coreLocationDataOnly
        ...
        var locationsCoor: [CLLocation] = []
        let altitude:CLLocationDistance = 10
        
        
//        // Bus Stop BLK 320
//        let pinCoordinate = CLLocationCoordinate2D(latitude: 1.432102, longitude: 103.778223)
//        let pinLocation = CLLocation(coordinate: pinCoordinate, altitude: altitude)
//        
//        locationsCoor.append(pinLocation)
//        
//        // BP Bus Stop Blk 270
//        let pinCoordinate2 = CLLocationCoordinate2D(latitude: 1.376098, longitude: 103.774259)
//        let pinLocation2 = CLLocation(coordinate: pinCoordinate2, altitude: altitude)
//        
//        locationsCoor.append(pinLocation2)
//        
//        
//        // BP Bus Stop Blk 223
//        let pinCoordinate3 = CLLocationCoordinate2D(latitude: 1.375798, longitude: 103.774216)
//        let pinLocation3 = CLLocation(coordinate: pinCoordinate3, altitude: altitude)
//        
//        locationsCoor.append(pinLocation3)
        
        
        
        // St Anthony Church
        let pinCoordinate = CLLocationCoordinate2D(latitude: 1.429603, longitude: 103.779645)
        let pinLocation = CLLocation(coordinate: pinCoordinate, altitude: altitude)
        
        locationsCoor.append(pinLocation)
        
        // Marsiling BLK 307
        let pinCoordinate2 = CLLocationCoordinate2D(latitude: 1.429474, longitude: 103.776426)
        let pinLocation2 = CLLocation(coordinate: pinCoordinate2, altitude: altitude)
        ...
        // Woodgrove
        let pinCoordinate3 = CLLocationCoordinate2D(latitude: 1.428357, longitude: 103.778465)
        let pinLocation3 = CLLocation(coordinate: pinCoordinate3, altitude: altitude)
        ...
        for location in locationsCoor {
            let pinImage = UIImage(named: "pin")!
            let pinLocationNode = LocationAnnotationNode(location: location, image: pinImage)
...
//        let pinImage = UIImage(named: "ht_emoji")!
            ...
            if touch.view != nil {
                if (mapView == touch.view! ||
                    ...
                    if location.x <= 40 && adjustNorthByTappingSidesOfScreen {
                        ...
                        let image = UIImage(named: "ht_emoji")!
